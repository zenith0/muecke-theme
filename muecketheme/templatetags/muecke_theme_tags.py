...
class SlotsInformationNode(Node):
    ...
    def render(self, context):
        ...
        if object is None:
            object = muecke.core.utils.get_default_shop(request)
...
@register.inclusion_tag('muecke/mail/mail_html_footer.html', takes_context=True)
...
@register.inclusion_tag('muecke/mail/mail_text_footer.html', takes_context=True)
